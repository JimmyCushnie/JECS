...
namespace JECS.MemoryFiles
{
    ...
    public class MemoryReadOnlyDataFile : ReadableDataFile
    {
        ...
        /// <summary>
        /// Creates a ReadOnlyDataFile in memory with some preexisting JECS content.
        /// </summary>
        ...
        {
            if (!overwrite && Utilities.JecsFileExists(relativeOrAbsolutePath))
                return null;
